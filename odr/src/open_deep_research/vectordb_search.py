...
async def vectordb_search(
    ...
    persist_dir = "/Users/a11492/Desktop/boot_camp/AI-Master-Project---Deep-Research/odr/chroma_db"
    collection_name = os.getenv("VECTORDB_COLLECTION", "kai_tech")
    embedding_model = os.getenv("EMBEDDING_MODEL", "text-embedding-3-small")
    outputs_dir = "/Users/a11492/Desktop/boot_camp/AI-Master-Project---Deep-Research/odr/outputs"
