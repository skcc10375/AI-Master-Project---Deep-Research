...
class Configuration(BaseModel):
    ...
    search_api: SearchAPI = Field(
        ...
        metadata={
            "x_oap_ui_config": {
                "type": "select",
                "default": "tavily",
                "description": "Web search API to use for research. NOTE: Make sure your Researcher Model supports the selected search API.",
                "options": [
    ...
    enable_vectordb_search: bool = Field(
        default=True,
        metadata={
            "x_oap_ui_config": {
                "type": "boolean",
                "default": True,
                "description": "Enable vector database search tool for searching internal documentation and knowledge base",
            }
        },
    )
